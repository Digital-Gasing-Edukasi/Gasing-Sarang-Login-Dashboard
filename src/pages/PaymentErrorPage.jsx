...
function Decorations() {
  return (
    <>
      <div className="absolute inset-0 bg-gradient-to-br from-[#fff5f5] via-[#fff7f7] to-[#fff5f5] pointer-events-none -z-20" />
      <svg
        className="absolute bottom-0 left-0 w-full text-[#7f1d1d] pointer-events-none -z-10"
  ...
  return (
    <div className="min-h-screen relative overflow-hidden font-sans z-0 flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col items-center justify-center px-8 pb-32 animate-fade-in-up">
        ...
        <h1 className="text-[40px] font-bold text-red-500 mb-4 tracking-tight text-center">
          Pembayaran Gagal
        </h1>
        ...
        {orderId && (
          <p className="text-xs text-gray-400 mb-8 font-mono">Order ID: {orderId}</p>
        )}
        <a
          href={BASE}
          className={cn(
            'px-10 py-3.5 rounded-full font-semibold text-white text-[15px]',
            'bg-red-500 hover:bg-red-600 active:scale-[0.98] transition-all duration-200 shadow-md',
