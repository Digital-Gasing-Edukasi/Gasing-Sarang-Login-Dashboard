...
// kiri + konten meluas (dibatasi max-w-6xl biar tetap enak dibaca).
export default function KomunitasPage() {
  return (
    <div className="min-h-screen bg-[#F1F2F7] lg:flex">
      <BottomNav />
      <main className="relative mx-auto w-full min-h-screen max-w-[480px] bg-[#F1F2F7] pb-24 shadow-sm lg:mx-0 lg:min-w-0 lg:max-w-none lg:flex-1 lg:pb-0 lg:shadow-none">
        <div className="lg:mx-auto lg:max-w-6xl lg:px-6 lg:py-6">
          <Routes>
            ...
            <Route path="materi-gasing/:slug" element={<MateriDetailScreen />} />
