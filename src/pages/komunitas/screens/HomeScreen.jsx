      ...
      <div className="relative bg-gradient-to-br from-blue-700 to-blue-400 px-5 pb-24 pt-4 text-white lg:-mx-6 lg:-mt-6 lg:px-10 lg:pb-20 lg:pt-10">
        ...
        <div className="relative mt-14 min-h-[80px] lg:mt-0 lg:flex lg:min-h-[140px] lg:items-center lg:justify-center">
          ...
          <img
            ...
            alt=""
            aria-hidden
            className="absolute -left-2 -bottom-10 hidden h-40 w-auto object-contain lg:block lg:-bottom-4 lg:left-6"
          />
          ...
          <img
            ...
            alt=""
            aria-hidden
            className="absolute -right-2 -bottom-10 h-36 w-auto object-contain lg:hidden"
          />
        </div>
      </div>
      ...
      <div className="lg:hidden">
        ...
        <div className="mt-4 px-5">
          <div className="rounded-2xl bg-white/70 p-5 opacity-70 blur-[1px]">
            <h2 className="text-center text-lg font-bold text-slate-400">
              Virtual Meet-Up Berikutnya
            </h2>
        ...
        <div className="relative mt-5">
          <div className="pointer-events-none grid select-none grid-cols-2 gap-5 blur-[5px]">
              ...
              <div className="mt-3 flex flex-col divide-y divide-slate-100">
                {materiUpdates.map((u) => (
                  <div key={u.id} className="flex gap-3 py-3">
                    <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-sky-400 to-blue-500 text-xs font-bold text-white">
                      GA
                    </span>
                    <div className="min-w-0 flex-1">
                      ...
                      <div className="mt-1.5 flex items-center gap-3">
                        ...
                        <span className="flex items-center gap-1 text-xs text-slate-400">
                          <Heart size={12} /> {u.likes}
                        </span>
                        <span className="flex items-center gap-1 text-xs text-slate-400">
                          <MessageCircle size={12} /> {u.comments}
                        </span>
                      </div>
                    </div>
                  </div>
            ...
            <div className="relative flex flex-col items-center justify-end overflow-hidden rounded-2xl bg-gradient-to-br from-emerald-50 to-white p-6 text-center shadow-md">
              <div
                className="flex flex-1 items-center justify-center gap-3 py-4 text-6xl"
                aria-hidden
              >
                📚🐙🎨🐢
              </div>
              <h3 className="text-xl font-extrabold text-slate-800">
                Cari produk lain untuk mengajar anak dan siswa?
              </h3>
              <Link
                to="#"
                className="mt-4 w-full max-w-xs rounded-full bg-gradient-to-r from-blue-600 to-indigo-500 py-3 text-sm font-bold text-white shadow-lg"
              >
