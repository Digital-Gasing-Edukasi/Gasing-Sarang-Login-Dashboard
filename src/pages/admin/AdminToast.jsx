...
export function AdminToast({ toast, onUndo }) {
  ...
  return (
    <div className="fixed top-8 left-1/2 -translate-x-1/2 z-[100] bg-[#030B1F] text-white px-6 py-3.5 rounded-2xl shadow-lg flex items-center gap-6 font-sans text-[16px] animate-in slide-in-from-top-4 fade-in duration-300">
