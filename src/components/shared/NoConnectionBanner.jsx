...
// Toast error "tidak ada jaringan" (flow 5). Pill merah #EF4444, rounded-16,
// whitespace-nowrap. Posisi = pojok atas tengah VIEWPORT (fixed, bukan absolute
// dalam card) supaya konsisten dengan SuccessToast, bukan mengambang di tengah layar.
