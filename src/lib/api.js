...
export const authApi = {
  ...
  confirmEmail: (token, otp) => request('/auth/confirm-email', {
    method: 'POST',
    body: { token, otp },
  }),
  ...
  resetPassword: (token, email, newPassword) => request('/auth/reset-password', {
    method: 'POST',
    body: { token, email, newPassword },
  }),
}
...
export const profileApi = {
  ...
  changePassword: (currentPassword, newPassword) => request('/profile/password', {
    method: 'PATCH',
    body: { currentPassword, newPassword },
  }),
  ...
  // Body: { token }
  confirmEmailChange: (token) => request('/profile/confirm-email', {
    method: 'POST',
    body: { token },
  }),
}
...
export const regionsApi = {
  ...
  list: () => fetch(`${BASE_URL}/training-regions`, {
